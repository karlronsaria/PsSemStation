...
CREATE INDEX IF NOT EXISTS item_has_tag_itemid_idx ON item_has_tag (itemid ASC);
CREATE INDEX IF NOT EXISTS item_has_tag_tagid_idx ON item_has_tag (tagid ASC);
CREATE INDEX IF NOT EXISTS item_has_datetag_itemid_idx ON item_has_datetag (itemid ASC);
